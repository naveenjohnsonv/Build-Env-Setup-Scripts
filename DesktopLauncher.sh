...
sudo git clone https://github.com/SebaUbuntu/TWRP-device-tree-generator
sudo mv ~/Android/Recoveries/TWRP-device-tree-generator ~/Android/Recoveries/Device-Tree-Generator
